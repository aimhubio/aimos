...
from aimos._sdk.container import Container
from aimos._sdk.sequence import Sequence
from aimos._sdk.action import Action
from aimos._sdk.collections import ContainerCollection, SequenceCollection
from aimos._sdk.query_utils import construct_query_expression
from aimos._sdk.constants import KeyNames
# from aimos._sdk.exceptions import AmbiguousQueryTypeError, UnknownQueryTypeError

from aimos._sdk.storage_engine import StorageEngine
from aimos._sdk.local_storage import LocalStorage
from aimos._sdk.remote_storage import RemoteStorage, RemoteRepoProxy

from aimos._ext.system_info.resource_tracker import ResourceTracker
...
class Repo(object):
    ...
    def delete_containers(self, container_hashes: List[str]) -> Tuple[bool, List[str]]:
        """Deletes multiple Containers data from aimos repository
    ...
    def delete_container(self, container_hash: str) -> bool:
        """Delete Container data from aimos repository
    ...
    def prune(self):
        ...
        """
        from aimos._sdk.utils import prune
        if self._is_remote_repo:
